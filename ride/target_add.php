...
// 데이터 삽입 쿼리
$sql = "INSERT INTO target (target_name, target_wait_time, target_open_time, target_close_time, target_min_height, target_max_height, target_x, target_y, target_status, target_utilization, target_precautions, manager_code) 
        VALUES ('$target_name', '$wait_time', '$open_time', '$close_time', '$min_height', '$max_height', '$target_x', '$target_y', '$target_status', '$target_utilization', '$target_precautions', '$manager_code')";
